    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            <h4 className="text-sm font-medium text-muted-foreground mb-1">희망 직무</h4>
            <p>{resume.desired_position}</p>
          </div>
          <div>
            <h4 className="text-sm font-medium text-muted-foreground mb-1">희망 지역</h4>
            <p>{REGION_LABELS[resume.desired_region as keyof typeof REGION_LABELS]}</p>
          </div>
          {resume.desired_salary && (
            <div>
              <h4 className="text-sm font-medium text-muted-foreground mb-1">희망 급여</h4>
      ...
      {resume.certifications && (
        <Card>
          ...
          <CardContent>
            <p className="whitespace-pre-wrap">{resume.certifications}</p>
          </CardContent>
        </Card>
      )}
    </div>
